...
namespace uTorrentMonitor
{
    ...
    /// </summary>
    public class uTorrentMonitorEntrPoint : IServerEntryPoint
    {
        /// <summary>
        /// Gets the instance.
        /// </summary>
        /// <value>The instance.</value>
        public static uTorrentMonitorEntrPoint Instance { get; private set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="uTorrentMonitorEntrPoint" /> class.
        /// </summary>
        /// <param name="taskManager">The task manager.</param>
        /// <param name="appPaths">The app paths.</param>
        /// <param name="logManager"></param>
        public uTorrentMonitorEntrPoint(ITaskManager taskManager, ILibraryManager libraryManager, IApplicationPaths appPaths, ILogManager logManager, ISecurityManager securityManager)
        {
  ...
  //      {
            //Plugin.Instance.Registration = await PluginSecurityManager.GetRegistrationStatus("uTorrentMonitor", "[**MB2CompatibleFeature**]").ConfigureAwait(false);
    //    }
    }
}
